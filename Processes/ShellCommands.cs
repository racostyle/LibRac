...
namespace LibRac.Processes
{
    internal class ShellCommands
    {
        ...
        internal string Get_KillProcessesByName_FastUnsafe(params string[] args)
        {
        ...
        internal string Get_KillProcessesByName(bool limitScopeToCurrentUser = true, params string[] args)
        {
