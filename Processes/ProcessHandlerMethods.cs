...
namespace LibRac.Processes
{
    internal class ProcessHandlerMethods
    {
        ...
        public string SaveProcessInfo(System.Diagnostics.Process process, string fullFileName)
        {
            ...
            return "Process PID and TimeCreated saved successfully";
        }
        ...
        {
            var command = shellCommands.Get_KillProcessesByName_FastUnsafe(args);
        ...
        {
            var command = shellCommands.Get_KillProcessesByName(limitScopeToCurrentUser, args);
            return Task.Run(() => ExecuteInBackgroundAsync(command, true)).Result;
        }
        ...
        #region AUXILIARY
        internal async Task FindProcessesByWindowStyle()
        {
