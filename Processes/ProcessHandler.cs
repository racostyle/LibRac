...
namespace LibRac.Processes
{
    ...
    {
        private static readonly ProcessHandlerMethods _processHandler = new ProcessHandlerMethods();
        ...
        /// </remarks>
        public static string SaveProcessInfo(System.Diagnostics.Process process, string fullFileName)
        {
